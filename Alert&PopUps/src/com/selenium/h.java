...
//        System.out.println(s);
        ...
        System.out.println(s);
        Thread.sleep(1000);
        alert2.dismiss();//this can only be done using this method only.
        ...
        Thread.sleep(1000);
        alert3.accept();//same case as above.
        ...
        Thread.sleep(1000);
        Actions act = new Actions(driver);//this syntax is constant.
        act.doubleClick(doubleBtn).perform();//.perform is also constant here
        ...
        //Point 6
        Robot robot = new Robot();//builds new cursor.
